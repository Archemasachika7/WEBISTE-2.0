...
// Try button should also redirect to registration
if (tryBtn) {
...
function handleMouseParallax(e) {
  ...
  document.querySelectorAll(".preview-window, .tabs-content").forEach((element) => {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (typeof THREE !== "undefined" && globeContainer) {
    initGlobe();
    createConnections();
  }
  ...
  // Check for URL parameters to auto-open tabs or sections
